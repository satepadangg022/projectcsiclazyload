...
{{-- Loading Type Badge --}}
<div class="loading-badge">LAZY LOADING</div>

{{-- Stats Badge --}}
<div class="stats-badge">
    <div><strong>Loading Stats:</strong></div>
    <div>Loaded: <span class="loaded-count" id="loaded-count">0</span>/<span id="total-count">0</span></div>
    <div style="font-size: 11px; margin-top: 8px; color: #aaa;">Using Intersection Observer API</div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let loadedCount = 0;
    totalCountEl.textContent = lazyImages.length;
