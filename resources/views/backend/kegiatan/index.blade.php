        ...
        <div class="card my-4">
          ...
          @endif
            <div class="d-flex justify-content-end mb-3" style="margin-right: 30px">
              <a href="{{ route('create.kegiatan') }}" class="btn btn-sm btn-primary">Tambah</a>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <a href="{{route('edit.kegiatan',$d->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit Data">
                        Edit
                      </a>
                      |
                      <a href="{{ route('delete.kegiatan', $d->id) }}"
